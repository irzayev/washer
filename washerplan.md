...
* несколько филиалов
* веб интерфейс и веб админ панель
...
### Категории услуг (также можно редактировать и добавлять кастомные)
...
* наличные
* POS терминал
* Azericard (документация по интеграции в файле Azericard-integration.mhtml)
* банковский перевод
* бонусы
* смешанная оплата
...
- payment\\\\\\\_status
```
также нужно иметь возможность настройки учета НДС (18% в Азербайджанской республике)
### Таблица платежей
...
### для завершения заказа требуется указать использованные материалы

→ указание и списание использованных материалов указывается относительно шаблона и может редактироваться вручную
